                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form id="add_seg_form" class="form-horizontal form-label-left" novalidate=""
                                        method="post">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control col-md-7 col-xs-12" id="fa" name="fa"
                                                    required="">
                                                    <?php
                                                                ...
                                                                foreach ($fa as $value) {
                                                                    ?>
                                                    <option value="<?php echo $value->idFa; ?>">
                                                        <?php echo $value->nomFa; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
